...
export const CONTRIBUTING_CIRCUMSTANCES = [
  ...
  { value: 'looseSurface', label: 'Sand, mud, dirt, or gravel surface' },
  ...
  { value: 'roadwayObstruction', label: 'Obstruction in roadway' },
  { value: 'trafficControlIssue', label: 'Traffic control issue' },
  { value: 'animalRoadway', label: 'Animal in roadway' },
  { value: 'workZone', label: 'Work zone' },
  { value: 'nonHighwayWork', label: 'Non-highway work' },
